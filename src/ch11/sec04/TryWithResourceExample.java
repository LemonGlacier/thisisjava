...
public class TryWithResourceExample {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(Integer.parseInt(res1.read2()));    //예외
		//리소스 닫기(실행 안됨)
		//res1.close();
		} catch(Exception e) {
			e.printStackTrace();
		...
		try (MyResource res2 = new MyResource("res2");){		
			...
			System.out.println(Integer.parseInt(res2.read2()));    //예외
			//리소스 닫기(실행 안됨)
			//res1.close();
			} catch(Exception e) {
				e.printStackTrace();
		...
		try (res3){		
			...
			//System.out.println(Integer.parseInt(res3.read2()));    //예외
			} catch(Exception e) {
				e.printStackTrace();
			} 
		...
		try (res4; res5){		
			...
			System.out.println(Integer.parseInt(res5.read1()));    //예외
			} catch(Exception e) {
				e.printStackTrace();
			} 
	}
